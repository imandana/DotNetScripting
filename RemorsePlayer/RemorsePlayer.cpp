...
//////////////////////////////////////////////////////////
    ...
    const char_t *dotnet_type_GO = STR("MyGame.Lulu, RemorseEngine");
	...
	// Function pointer to managed delegate with non-default signature
    typedef int (CORECLR_DELEGATE_CALLTYPE *custom_change_objChanged_from_managed)();
    custom_change_objChanged_from_managed GetIsChanged = nullptr;
    rc = load_assembly_and_get_function_pointer(
        dotnetlib_path.c_str(),
        dotnet_type_GO2,
